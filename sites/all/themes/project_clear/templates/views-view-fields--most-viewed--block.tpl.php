    ...
    <div class="view view-first">
        <?php print $fields['field_money_shot']->content?>
	        <div class="mask hide-for-touch hide-for-small">
	            ...
	            <div class="hoverStat hide-for-small" style="margin-left:85px; width:50px"><?php print $fields['field_bed_number']->content?><span>beds</span></div>
	            ...
	            <div class="hide-for-small" style="float:left; margin:20px 0 0 180px"><?php print $fields['nid']->content?></div>
        </div>
    </div>
</div>